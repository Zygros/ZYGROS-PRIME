...
It runs **UP-OS Core (immutable)** for safety/perf and a **malleable Universal Plugin Language (UPL)** shell for infinite customization. Users load “capability cartridges” (plugins/metaprompts/scripts/APIs) the way gamers load titles and modpacks.
